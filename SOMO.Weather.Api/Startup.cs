...
using SOMO.Weather.Api.Application.GetWeather.EventHandler.Implementation;
    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSwaggerGen(c =>
            {
                ...
                {
                    Title = "SOMO Weather API",
                    Version = "v1",
                    Description = "Description for the SOMO Weather API.",
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "SOMO Weather API");
